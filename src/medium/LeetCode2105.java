...
currently in his/her watering can should water this plant. If they have the same amount of water, 
then Alice should water this plant.
Given a 0-indexed integer array plants of n integers, where plants[i] is the amount of 
water the ith plant needs, and two integers capacityA and capacityB representing the 
capacities of Alice's and Bob's watering cans respectively,
...
public class LeetCode2105 {
	...
	public int minimumRefill(int[] plants, int capacityA, int capacityB) {
		int refil=0;
		int incCapA=capacityA;
		int incCapB=capacityB;
	...
	public static void main(String args[]) {
		LeetCode2105 lc2105 = new LeetCode2105();
		int[] array= {1,2,4,4,5};
		lc2105.minimumRefill(array, 2, 2);
	}
}
